...
const RISK_RULES = [
  { id: 'R1', text: 'ผู้ชนะรายเดิมซ้ำในหมวดงานเดียวกัน', cat: 'การแข่งขัน' },
  ...
  { id: 'R5', text: 'สัญญาคล้ายกันหลายฉบับในช่วงเวลาสั้น', cat: 'กระบวนการ' },
  { id: 'R6', text: 'อาจมีการแบ่งซื้อแบ่งจ้าง', cat: 'กระบวนการ' },
  ...
  { id: 'R9', text: 'ถ้อยคำ TOR ซ้ำกันระหว่างโครงการ', cat: 'กระบวนการ' },
  { id: 'R10', text: 'ราคาสูงกว่ากลุ่มหน่วยงานเปรียบเทียบ', cat: 'ราคา' },
  { id: 'R11', text: 'เอกสารที่ต้องเปิดเผยหายไปหรือเข้าถึงไม่ได้', cat: 'การเปิดเผยข้อมูล' },
  { id: 'R12', text: 'ตัวเลขหรือวันที่ขัดแย้งกันระหว่างเอกสาร', cat: 'คุณภาพข้อมูล' },
...
const SOURCE_TYPES = [
  ...
  {
    title: 'ทะเบียนนิติบุคคล (DBD)',
    desc: 'ข้อมูลจดทะเบียนนิติบุคคลที่เปิดเผยต่อสาธารณะ: เลขทะเบียน ที่อยู่ กรรมการ และบัญชีรายชื่อผู้ถือหุ้น (บอจ.5) — ใช้จับคู่ชื่อบริษัทและตรวจความสัมพันธ์กับผู้ชนะการประมูล',
  },
  {
    title: 'ทำเนียบผู้บริหารหน่วยงาน',
    desc: 'รายชื่อผู้บริหารทุกระดับจากเว็บไซต์ทางการ คำสั่งแต่งตั้ง และราชกิจจานุเบกษา — นายกฯ/ผู้อำนวยการ รองฯ ปลัด หัวหน้าส่วน และเจ้าหน้าที่พัสดุ — ใช้ตรวจความเชื่อมโยงกับกรรมการและผู้ถือหุ้นของบริษัทที่ชนะการประมูล',
  },
  {
