...
const RISK_RULES: {
  ...
  { id: 'R4', text: 'ราคาที่ตกลงใกล้เพดานงบประมาณมาก (ใช้งบประมาณเป็น proxy — ไม่ใช่ราคากลางราชการ)', cat: 'ราคา', dim: 'BID' },
  ...
  { id: 'R13', text: 'นามสกุลเจ้าหน้าที่ตรงกับกรรมการ/ผู้ถือหุ้นผู้ชนะ — lead ไม่ใช่ข้อพิสูจน์ (ชื่อเต็มยกระดับ)', cat: 'ความสัมพันธ์', dim: 'COI' },
