...
export const THAI_GOV_API_CATALOG: GovApiEntry[] = [
  {
    ...
    fit: 'core',
    why: 'แหล่งหลักสัญญา e-GP / การใช้จ่ายภาครัฐเมื่อ endpoint ใช้ได้ — TRACE24 ใช้ OPEND_API_KEY อยู่แล้ว',
    auth: 'api-key หลังสมัครฟรี',
    statusNote: 'cgdcontract ปัจจุบันมัก 404 หลังย้ายพอร์ทัล — ใช้ประกาศหน่วยงานสำรอง',
  ...
  },
  {
    ...
    access: 'public_open',
    fit: 'core',
    why: 'ค้นหาชุดงบประมาณ / จัดซื้อ / รายงานหน่วยงานแบบ machine-readable',
    auth: 'หลายชุดไม่ต้อง key; บางชุดชี้ไป Open D',
    statusNote: 'ใช้ package_search / package_show ได้ทันที',
  },
  {
    id: 'govspending-web',
    ...
    docsUrl: 'https://govspending.data.go.th/api/documentation',
    access: 'public_open',
    fit: 'core',
    why: 'ค้นหาการใช้จ่าย / จัดซื้อด้วยมือ และอ้างอิงแหล่งสาธารณะ',
    auth: 'เว็บเปิด; API แยก (ถ้ามี) เคยใช้ token',
    statusNote: 'เอกสาร API เก่า/ไม่เสถียร — เว็บยังใช้ได้',
  },
  {
    ...
    access: 'public_open',
    fit: 'core',
    why: 'แหล่งราคา/ผู้ชนะที่ TRACE24 ใช้จริงตอนนี้ (scrape + decode)',
    auth: 'ไม่ต้อง key',
    statusNote: 'live ใน scripts/fetch-real-data',
  },
  {
    id: 'bot-api',
